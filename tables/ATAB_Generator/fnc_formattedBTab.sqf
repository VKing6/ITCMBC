...
_btab = [_magazine, _elevMin, _elevMax, _elevStep, _heightMin, _heightMax, _heightStep, _muzzleVelocity, _airFriction] call compile preprocessFileLineNumbers "fnc_calcBallistics.sqf";
